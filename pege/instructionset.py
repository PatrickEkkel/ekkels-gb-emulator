...
instructions = [{'m': 'XOR r'      , 'datatype': '',    'opcode': opcodes.XOR_r    , 'length': 1, 'cycles': 4,       'jump_instruction': False, 'register_options': {'A': 0xAF, 'C': 0xA9}    },
                ...
                {'m': 'JP nnnn'    , 'datatype': '',    'opcode': opcodes.JP_nnnn  , 'length': 3, 'cycles': [16, 16],'jump_instruction': True , 'register_options': {'x': 0xC3 },'oc_handler': NewOpcodeContext   },
                ...
                {'m': 'JRNZ nnnn'  , 'datatype': 'r8',  'opcode': opcodes.JRNZ_r8  , 'length': 2, 'cycles': [8, 12], 'jump_instruction': True , 'register_options': {'x': 0x20   }, 'oc_handler': NewOpcodeContext },
                {'m': 'JRZ nnnn'   , 'datatype': 'r8',  'opcode': opcodes.JRZ_r8   , 'length': 2, 'cycles': [8, 12], 'jump_instruction': True , 'register_options': {'x': 0x28   }, 'oc_handler': NewOpcodeContext },
                {'m': 'JPZ nnnn'   , 'datatype': 'a16', 'opcode': opcodes.JP_Z_nnnn, 'length': 3, 'cycles': [12, 16],'jump_instruction': True , 'register_options': {'x': 0xCA   } },
                {'m': 'JR nnnn'    , 'datatype': 'r8',  'opcode': opcodes.JR_nnnn  , 'length': 2, 'cycles': [12, 12],'jump_instruction': True , 'register_options': {'x': 0x18   }, 'oc_handler': NewOpcodeContext },
                ...
                {'m': 'LD (rr) nn' , 'datatype': 'd8',  'opcode': opcodes.LD_rr_nn , 'length': 2, 'cycles': 12,      'jump_instruction': False, 'register_options': {'(HL)': 0x36 } },
                ...
                {'m': 'INC r'      , 'datatype': ''   , 'opcode': opcodes.INC_r    , 'length': 1, 'cycles': 4,       'jump_instruction': False, 'register_options': {'A': 0x3C, 'C': 0xC, 'B': 0x04, 'H': 0x24, 'E': 0x1C, 'L': 0x2C, 'D': 0x14 }, 'oc_handler': NewOpcodeContext },
                ...
                {'m': 'LD (rr) r'  , 'datatype': ''   , 'opcode': opcodes.LD_i_rr_r, 'length': 1, 'cycles': 8,       'jump_instruction': False, 'register_options': {'(HL) A': 0x77, '(DE) A': 0x12}},
                {'m': 'RET'        , 'datatype': ''   , 'opcode': opcodes.RET      , 'length': 1, 'cycles': 16,      'jump_instruction': False, 'register_options': {'x': 0xC9 } },
                {'m': 'RETI'       , 'datatype': ''   , 'opcode': opcodes.RETI     , 'length': 1, 'cycles': 16,      'jump_instruction': False, 'register_options': {'x': 0xD9 }, 'oc_handler': NewOpcodeContext },
                ...
                {'m': 'INC (rr)'   , 'datatype': ''   , 'opcode': opcodes.INC_HL   , 'length': 1, 'cycles': 12,      'jump_instruction': False, 'register_options': {'(HL)': 0x34}, 'oc_handler': NewOpcodeContext },
